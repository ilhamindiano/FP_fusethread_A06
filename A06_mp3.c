...
//thread untuk memutar lagu dan setiap ada perubahan lagu
...
//untuk memasukkan nama2 lagu kedalam array of string
void initSong(){
    DIR *dp;
	struct dirent *de;
...
//untuk mencari index lagu diplaylist
