...
static const char *dirpath = "/home/z/finalproject"; 
...
//rekursif untuk mencari file mp3 dr berbagai folder dan sub folder
void findsong(char path[100]){
	...
	while ((de = readdir(dp)) != NULL) {
        if(strcmp(de->d_name,"..") != 0 && strcmp(de->d_name,".") != 0){
            ...
            strcpy(target,"/home/z/finalproject");
            ...
            if(strcmp(fpath,"/home/z/finalproject") != 0){
                findsong(fpath);
            }
...
{
    pid_t child_id;
    char *arg[4] = {"mv","**/*.mp3","/home/z/finalproject",NULL};

    findsong("/home/z/finalproject");
